...
4. ถ้ามีข้อมูลอยู่ในเครื่องเดิม: บันทึก URL แล้วระบบ **อัปโหลดอัตโนมัติ** (ถ้า Google Sheet ยังว่าง)
...
- ก่อนบันทึกรับเข้า/เบิก ระบบดึงข้อมูลล่าสุดก่อนเพื่อลดการทับกัน
